 ...
 *         &lt;element name="DocumentoReferencia" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "ConsultarEstatusRemesasDocReferenciaOSB")
public class ConsultarEstatusRemesasDocReferenciaOSB {

    @XmlElement(name = "Clave")
    protected String clave;
    @XmlElement(name = "DocumentoReferencia")
    protected String documentoReferencia;
     ...
     *     
     */
    public void setDocumentoReferencia(String value) {
